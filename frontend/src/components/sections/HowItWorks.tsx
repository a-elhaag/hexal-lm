      ...
      <div className="sticky top-0 h-screen flex flex-col items-center justify-center px-14">
        ...
        <div className="w-full max-w-285 mx-auto">
          ...
          <div
            ...
            style={{
              height: "52px",
              background: "rgba(245,241,237,0.055)",
              border: "1.5px solid rgba(168,144,128,0.14)",
              borderRadius: "50px",
              overflow: "hidden",
            }}
          >
            ...
            <div className="absolute inset-0 flex">
              {steps.map((step, i) => (
                <div key={i} className="flex-1 flex items-center justify-center">
                  <span className="text-[0.72rem] font-bold text-muted opacity-30 tracking-wide">{step.num}</span>
                </div>
              ))}
            </div>
            ...
            >
              <span className="text-[0.78rem] font-bold text-surface tracking-wide">{steps[0]!.num}</span>
            </div>
          </div>
